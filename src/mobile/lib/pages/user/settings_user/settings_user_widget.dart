...
export 'settings_user_model.dart';

class SettingsUserWidget extends StatefulWidget {
  const SettingsUserWidget({super.key});

  static String routeName = 'settings_user';
  static String routePath = '/settingsUser';
        ...
        children: [
            ...
            children: [
              Padding(
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    context.pushNamed(AspectUserWidget.routeName);
                  },
                  child: Container(
          ...
          Padding(
            ...
            child: GestureDetector(
              onTap: () async {
                await launchURL('https://earthvibe.app');
              },
              child: Text(
                'v0.0.1',
                style: FlutterFlowTheme.of(context).labelMedium.override(
