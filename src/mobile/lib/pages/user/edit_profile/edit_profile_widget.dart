...
/// cea un apartado para editar perfil, que sea nombre, nombre de usuario y
/// bio
///
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (user != null) {
        safeSetState(() {
          ...
          _model.textController2?.text = user.username;
          _model.textController3?.text = user.bio ?? '';
        });
      }
    });
  }
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      ...
                      final bio = _model.textController3?.text.trim();
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            TextFormField(
                              ...
                              autofocus: false,
                              readOnly:
                                  true, // No se puede editar el nombre de usuario
                              textCapitalization: TextCapitalization.none,
                              textInputAction: TextInputAction.next,
                              obscureText: false,
                              decoration: InputDecoration(
                                hintText: 'Elige un nombre de usuario único',
                                hintStyle: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      font: GoogleFonts.plusJakartaSans(
