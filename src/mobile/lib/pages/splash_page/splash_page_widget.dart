...
class _SplashPageWidgetState extends State<SplashPageWidget> {
  ...
  void dispose() {
    ...
    () async {
      if (FFAppState().permissionsGranted) {
        await requestPermission(notificationsPermission);
        await requestPermission(cameraPermission);
      }
      FFAppState().permissionsGranted = true;
      FFAppState().update(() {});
    }();
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        12.0, 4.0, 12.0, 0.0),
                                    child: Text(
                                      'Tu acción tiene un impacto real. Transforma tus botellas de plástico en un cambio positivo para el planeta.',
                                      style: FlutterFlowTheme.of(context)
                                          .labelLarge
                                          .override(
                                            font: GoogleFonts.outfit(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        12.0, 4.0, 12.0, 0.0),
                                    child: Text(
                                      '1. Lleva tus botellas al módulo Vibe Pod.\n2. El pod escaneará tus botellas y te dará un código QR.\n3. Usa esta app para escanear ese QR y... ¡listo!',
                                      style: FlutterFlowTheme.of(context)
                                          .labelLarge
                                          .override(
                                            font: GoogleFonts.outfit(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        12.0, 4.0, 12.0, 0.0),
                                    child: Text(
                                      'Acumula puntos y canjéalos por recompensas. Sube en el ranking, completa misiones y comparte tus logros con la comunidad.',
                                      style: FlutterFlowTheme.of(context)
                                          .labelLarge
                                          .override(
                                            font: GoogleFonts.outfit(
