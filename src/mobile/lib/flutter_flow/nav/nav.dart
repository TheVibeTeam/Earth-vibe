...
class AppStateNotifier extends ChangeNotifier {
  ...
  EarthVibeAuthUser? initialUser;
  EarthVibeAuthUser? user;
  ...
  void update(EarthVibeAuthUser newUser) {
    final shouldUpdate =
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
            ...
            builder: (context, params) => params.isEmpty
                ? NavBarPage(initialPage: 'profile_user')
                : NavBarPage(
                    initialPage: 'profile_user',
                    page: ProfileUserWidget(),
                  )),
        FFRoute(
        ...
        FFRoute(
          name: AspectUserWidget.routeName,
          path: AspectUserWidget.routePath,
          builder: (context, params) => AspectUserWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) => PostWidget(
            // Prefer the deserialized param, but fall back to raw query param
            postId: params.getParam('postId', ParamType.String) ??
                params.state.uri.queryParameters['postId'] ??
                '',
          ),
        ),
        FFRoute(
